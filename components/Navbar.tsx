  ...
  return (
    <nav className='bg-white shadow-md py-4 border-b border-gray-200'>
        ...
        <div className='container mx-auto flex justify-between items-center px-6 lg:px-8'>
            ...
            <div className="flez items-center space-x-4">
               {session ? (
                <>
              ...
              <button className="flex items-center justify-center bg-gray-800 hover:bg-gray-900 text-white p-2 rounded-2xl cursor-pointer"
              onClick={logout}>
                Singn Out
              </button>
              </>) : (
